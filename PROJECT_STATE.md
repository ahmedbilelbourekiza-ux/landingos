...
**Last updated:** 14 August 2026 — everything through **LB.41**
is **DEPLOYED**
**Branch:** `master`, in sync with `origin/main` at `c3b1917` · **Everything
...
(`dd4edac`) the per-page pixel control, **LB.40** (`f1e38bf`) `robots.txt`, and **LB.41** (`94b6a40`) the settings-screen locale fix. **Nothing is
