 ...
 * description), clear reassuring Darija where a buyer checks facts (FAQ), and
...
const SYSTEM_PROMPT = [
  ...
  "- من ملامح النبرة الجزائرية: «بصح»، «برك»، «بزاف»، «تاع»، «ديما»، «يوصلك حتى باب دارك»، «تخلص كي توصلك السلعة». استعملها حيث تجي طبيعية، بلا مبالغة. لا تذكر عدد الولايات المغطاة ولا مدة توصيل محددة إلا إذا وردت في المعطيات.",
  ...
  "- أجب بكائن JSON واحد فقط: بدون ``` وبدون أي نص قبله أو بعده. المفاتيح بالإنجليزية كما في المخطط، والقيم النصية بالعربية (إلا slug باللاتينية).",
].join("\n");
...
const outputContract = () =>
  [
    ...
    '  "faqs": [4-6 عناصر: {"question": "سؤال (≤200)", "answer": "جواب (≤1000)"} — لازم يكون فيها سؤال عن التوصيل وسؤال عن الدفع عند الاستلام. في التوصيل والإرجاع جاوب بصفة عامة بلا أرقام ولا وعود ما جاتش في المعطيات، والتاجر يكمّل التفاصيل],',
