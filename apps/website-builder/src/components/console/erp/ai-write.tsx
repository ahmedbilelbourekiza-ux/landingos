...
export function ProviderCreatePanel({
  ...
  return (
    <section className="rounded-lg border border-border bg-surface-raised p-4" data-testid="ai-provider-panel">
...
export function AgentCreatePanel({
  ...
  return (
    <section className="rounded-lg border border-border bg-surface-raised p-4" data-testid="ai-agent-panel">
